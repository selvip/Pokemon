...
describe 'Pokemon validation' do
	...
	it "Pokemon's battle deleted if Pokemon is deleted." do
		pokedex_sample_1 = ::Pokedex.new
		pokedex_sample_1.name = "Pokedess"
		pokedex_sample_1.base_health_point = 10
		pokedex_sample_1.base_attack = 10
		...
		sample_1.destroy
		expect(PokemonBattle.all).to eq([])
	end

	it "Pokemon is deleted once the Pokedex does not exist." do
		pokedex_sample_1 = ::Pokedex.new
		pokedex_sample_1.name = "Pokedess"
		pokedex_sample_1.base_health_point = 10
		pokedex_sample_1.base_attack = 10
		...
		pokedex_sample_1.destroy
		expect(Pokemon.all).to eq([])
	end
end